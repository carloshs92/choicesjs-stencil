...
const ChoicesJSStencil = class {
    ...
    render() {
        ...
        switch (this.type) {
            case 'single':
                this.element =
                    core.h("select", Object.assign({}, attributes), this.value ? this.createSelectOptions(this.value) : null);
                break;
            case 'multiple':
                this.element =
                    core.h("select", Object.assign({ multiple: true }, attributes), this.value ? this.createSelectOptions(this.value) : null);
                break;
            case 'text':
            default:
                this.element =
                    core.h("input", Object.assign({ type: "text", value: this.value }, attributes));
                break;
        }
        return this.element;
    }
    ...
    createSelectOptions(values) {
        return getValues(values).map((value) => core.h("option", { value: value }, value));
    }
